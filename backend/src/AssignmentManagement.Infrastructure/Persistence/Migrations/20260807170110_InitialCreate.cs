    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TeachingAssignmentId = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
                    DeadlineUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    MaximumMarks = table.Column<decimal>(type: "numeric(7,2)", precision: 7, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Assignments_MaximumMarks", "\"MaximumMarks\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    AnswerText = table.Column<string>(type: "character varying(50000)", maxLength: 50000, nullable: false),
                    ...
                    LastSubmittedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    MarksAwarded = table.Column<decimal>(type: "numeric(7,2)", precision: 7, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Submissions_MarksAwarded", "\"MarksAwarded\" IS NULL OR \"MarksAwarded\" >= 0");
                    table.ForeignKey(
                        name: "FK_Submissions_AspNetUsers_GradedBy",
                        column: x => x.GradedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_TeachingAssignmentId_Status_DeadlineUtc",
                table: "Assignments",
                columns: new[] { "TeachingAssignmentId", "Status", "DeadlineUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_StudentId_LastSubmittedAtUtc",
                table: "Submissions",
                columns: new[] { "StudentId", "LastSubmittedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingAssignments_TeacherId_CourseId_SubjectId",
                table: "TeachingAssignments",
